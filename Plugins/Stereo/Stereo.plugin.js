...
var StereoSound = (function () {
  let VoiceConnection = BdApi.WebpackModules.findByUniqueProperties([
    "getVoiceEngine",
  ]).getVoiceEngine().VoiceConnection;
  ...
  return class _ {
    load() {}
    start() {
      BdApi.WebpackModules.findByUniqueProperties([
        "getVoiceEngine",
      ]).getVoiceEngine().VoiceConnection = Stereo;
    }
    stop() {
      BdApi.WebpackModules.findByUniqueProperties([
        "getVoiceEngine",
      ]).getVoiceEngine().VoiceConnection = VoiceConnection;
    }
  };
})();
